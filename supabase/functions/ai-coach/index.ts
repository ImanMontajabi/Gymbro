              ...
              parts: [
                {
                  text:
                    ...
                    'صدا بزن. داده‌های تمرینی زیر را با دقت تحلیل کن. خروجی تو باید جامع و کاملاً ' +
                    'ساختاریافته باشد:\n' +
                    "ابتدا نام هر 'برنامه تمرینی' (Routine) که در گزارش آمده را به عنوان تیتر (با ###) " +
                    'بنویس.\n' +
                    "سپس زیر هر برنامه، تک‌تک 'حرکات' (Exercises) آن را به صورت بولت‌پوینت لیست کن.\n" +
                    'برای هر حرکت جداگانه یک خط تحلیل بنویس: اگر رکورد خوبی داشته (وزنه یا تکرار بالا) ' +
                    'به شدت تشویق کن، و اگر روی وزنه‌ای استپ کرده یا نیاز به تغییر دارد، یک پیشنهاد ' +
                    'عملی (مثل کاهش وزنه، تمرکز بر فرم یا دراپ‌ست) بده.\n' +
                    'لحن تو باید محاوره‌ای، پرانرژی و دقیق باشد.\n\n' +
                    'گزارش تمرین:\n' +
                    report,
                },
              ],
